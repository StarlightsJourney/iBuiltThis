import { CompassIcon, HomeIcon, LoaderIcon, SparklesIcon, UserIcon } from "lucide-react";
                    ...
                    <div className="flex items-center gap-3">
                        <Suspense fallback={
                            ...
                            <Show when="signed-out">
                                <SignInButton />
                                <SignUpButton>
                                    <Button className="rounded-sm shadow-lg px-4">
                                        Sign Up
                                    </Button>
                                </SignUpButton>
                            </Show>
                            <Show when="signed-in">
                                <Link href="/submit" className={buttonVariants({ variant: "default", size: "lg", className: "text-base px-4 shadow-lg rounded-sm" })}>
