...
import { Sparkles, ArrowRightIcon, RocketIcon, UsersIcon, EyeIcon } from "lucide-react";
import StatsCard from "./stats-card";

const LiveBadge = () => {
    return (
        <Badge variant="outline" className="h-auto bg-transparent px-4 py-2 mb-8 text-sm backdrop-blur-sm">
            <span className="relative flex h-2 w-2">
                <span className="absolute animate-ping h-full w-full rounded-full bg-primary opacity-75"></span>
            ...
            <div className="wrapper">
                <div className="flex flex-col items-center justify-center text-center py-12 lg:py-24">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 mb-16">
                        <Link href="/submit" className={buttonVariants({variant:"default", size:"lg", className:"text-base px-8 shadow-lg rounded-sm"})}>
                            <Sparkles className="size-5"/>
                            Share Your Project
                        </Link>
                        <Link href="/submit" className={buttonVariants({variant:"secondary", size:"lg", className:"text-base px-8 shadow-lg rounded-sm"})}>
                            Explore Projects
